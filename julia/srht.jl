...
#function srht_rec!{T<:Number,IT<:Integer}(pPHx::Ptr{T}, x::StridedArray{T},
...
#            
#            srht_rec!(pPHx, tmp, m, n, start, mid, L-1, p1, pstart, pstart+k1-1, ordering)
#         end
#         
#         #copy!(tmp, x[1:half,:])
#         #for j in 0:n-1
...
#            
#            srht_rec!(pPHx, tmp, m, n, mid+1, stop, L-1, p2, pstart+k1, pstop, ordering)
#         end
#
#      elseif L == 2
